...
urlpatterns = [
    ...
    path('sport_facilities/courts/non_operating_day/<non_operanting_day_id>/', views.DeleteNonOperantingDay.as_view(), name="delete_non_operanting_day-view"),
    path('sport_facilities/courts/<court_id>/holidays/', views.RegisterHolidayView.as_view(), name="register_holiday-view"),
    path('sport_facilities/courts/holidays/<holiday_id>/', views.DeleteHolidayView.as_view(), name="delete_holiday-view"),
]
